...
namespace BudgetManager.Data
{
    ...
    public partial class PurseDatabaseEntities : DbContext
    {
        private static PurseDatabaseEntities _context;
        public PurseDatabaseEntities()
            : base("name=PurseDatabaseEntities")
        {
        }
        ...
        public static PurseDatabaseEntities GetInstance()
        {
            if (_context == null) _context = new PurseDatabaseEntities();
            return _context;
        }
